...
$_mod.def("/marko_demo_01$1.0.0/02/hello.marko", function(require, exports, module, __filename, __dirname) { // Compiled using marko@4.9.4 - DO NOT EDIT
"use strict";
...
var marko_template = module.exports = require('/marko$4.9.4/src/vdom'/*"marko/src/vdom"*/).t(),
    ...
    marko_componentType = marko_registerComponent("/marko_demo_01$1.0.0/02/hello.marko", function() {
      return module.exports;
    }),
...
$_mod.def("/marko_demo_01$1.0.0/02/client", function(require, exports, module, __filename, __dirname) { var helloComponent = require('/marko_demo_01$1.0.0/02/hello.marko'/*'./hello'*/);
 
helloComponent.renderSync({ name:'Marko' })
    .appendTo(document.body);
});
$_mod.run("/marko_demo_01$1.0.0/02/client");